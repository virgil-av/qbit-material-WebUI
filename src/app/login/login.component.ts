...
export class LoginComponent implements OnInit {
  ...
  login(): void {
    ...
    const usernameField: any = document.getElementById('username');
    const passwordField: any = document.getElementById('password');

    const username = (usernameField.value as string).trim();
    ...
    const endpoint = this.http_endpoints.default.endpoints.login;
